...
#define BORDER_COLLAPSE_SHIFT 5
#define BORDER_COLLAPSE_MASK 0x60
...
#define BORDER_LEFT_COLOR_SHIFT 17
#define BORDER_LEFT_COLOR_MASK 0x60000
...
#define BORDER_RADIUS_BOTTOM_LEFT_INDEX 5
#define BORDER_RADIUS_BOTTOM_LEFT_SHIFT 18
#define BORDER_RADIUS_BOTTOM_LEFT_MASK 0x1fc0000

static inline css_error set_border_radius_bottom_left(css_computed_style
		*style, uint8_t type, css_fixed length, css_unit unit)
{
	uint32_t *bits;
	
	bits = &style->i.bits[BORDER_RADIUS_BOTTOM_LEFT_INDEX];
	
	/* 7bits: uuuuutt : unit | type */
	*bits = (*bits & ~BORDER_RADIUS_BOTTOM_LEFT_MASK) | ((((uint32_t)type &
			0x3) | (unit << 2)) << BORDER_RADIUS_BOTTOM_LEFT_SHIFT);
	
	style->i.border_radius_bottom_left = length;
	
	return CSS_OK;
}
#undef BORDER_RADIUS_BOTTOM_LEFT_INDEX
#undef BORDER_RADIUS_BOTTOM_LEFT_SHIFT
#undef BORDER_RADIUS_BOTTOM_LEFT_MASK

#define BORDER_RADIUS_BOTTOM_RIGHT_INDEX 8
#define BORDER_RADIUS_BOTTOM_RIGHT_SHIFT 11
#define BORDER_RADIUS_BOTTOM_RIGHT_MASK 0x3f800

static inline css_error set_border_radius_bottom_right(css_computed_style
		*style, uint8_t type, css_fixed length, css_unit unit)
{
	uint32_t *bits;
	
	bits = &style->i.bits[BORDER_RADIUS_BOTTOM_RIGHT_INDEX];
	
	/* 7bits: uuuuutt : unit | type */
	*bits = (*bits & ~BORDER_RADIUS_BOTTOM_RIGHT_MASK) | ((((uint32_t)type
			& 0x3) | (unit << 2)) <<
			BORDER_RADIUS_BOTTOM_RIGHT_SHIFT);
	
	style->i.border_radius_bottom_right = length;
	
	return CSS_OK;
}
#undef BORDER_RADIUS_BOTTOM_RIGHT_INDEX
#undef BORDER_RADIUS_BOTTOM_RIGHT_SHIFT
#undef BORDER_RADIUS_BOTTOM_RIGHT_MASK

#define BORDER_RADIUS_TOP_LEFT_INDEX 3
#define BORDER_RADIUS_TOP_LEFT_SHIFT 25
#define BORDER_RADIUS_TOP_LEFT_MASK 0xfe000000

static inline css_error set_border_radius_top_left(css_computed_style *style,
		uint8_t type, css_fixed length, css_unit unit)
{
	uint32_t *bits;
	
	bits = &style->i.bits[BORDER_RADIUS_TOP_LEFT_INDEX];
	
	/* 7bits: uuuuutt : unit | type */
	*bits = (*bits & ~BORDER_RADIUS_TOP_LEFT_MASK) | ((((uint32_t)type &
			0x3) | (unit << 2)) << BORDER_RADIUS_TOP_LEFT_SHIFT);
	
	style->i.border_radius_top_left = length;
	
	return CSS_OK;
}
#undef BORDER_RADIUS_TOP_LEFT_INDEX
#undef BORDER_RADIUS_TOP_LEFT_SHIFT
#undef BORDER_RADIUS_TOP_LEFT_MASK

#define BORDER_RADIUS_TOP_RIGHT_INDEX 5
#define BORDER_RADIUS_TOP_RIGHT_SHIFT 4
#define BORDER_RADIUS_TOP_RIGHT_MASK 0x7f0

static inline css_error set_border_radius_top_right(css_computed_style *style,
		uint8_t type, css_fixed length, css_unit unit)
{
	uint32_t *bits;
	
	bits = &style->i.bits[BORDER_RADIUS_TOP_RIGHT_INDEX];
	
	/* 7bits: uuuuutt : unit | type */
	*bits = (*bits & ~BORDER_RADIUS_TOP_RIGHT_MASK) | ((((uint32_t)type &
			0x3) | (unit << 2)) << BORDER_RADIUS_TOP_RIGHT_SHIFT);
	
	style->i.border_radius_top_right = length;
	
	return CSS_OK;
}
#undef BORDER_RADIUS_TOP_RIGHT_INDEX
#undef BORDER_RADIUS_TOP_RIGHT_SHIFT
#undef BORDER_RADIUS_TOP_RIGHT_MASK
...
#define BOX_SIZING_SHIFT 13
#define BOX_SIZING_MASK 0x6000
...
#define CAPTION_SIDE_SHIFT 19
#define CAPTION_SIDE_MASK 0x180000
...
#define COLUMN_RULE_COLOR_SHIFT 15
#define COLUMN_RULE_COLOR_MASK 0x18000
...
#define COUNTER_INCREMENT_INDEX 12
...
#define FLOAT_SHIFT 11
#define FLOAT_MASK 0x1800
...
#define FONT_STYLE_SHIFT 3
#define FONT_STYLE_MASK 0x18
...
#define JUSTIFY_CONTENT_SHIFT 17
#define JUSTIFY_CONTENT_MASK 0xe0000
...
#define LIST_STYLE_TYPE_MASK 0xf00
...
#define OPACITY_SHIFT 30
#define OPACITY_MASK 0x40000000
...
#define ORPHANS_SHIFT 28
#define ORPHANS_MASK 0x10000000
...
#define OVERFLOW_X_SHIFT 8
#define OVERFLOW_X_MASK 0x700
...
#define TABLE_LAYOUT_SHIFT 9
#define TABLE_LAYOUT_MASK 0x600
...
#define UNICODE_BIDI_MASK 0x600000
...
#define WIDOWS_SHIFT 29
#define WIDOWS_MASK 0x20000000
...
#define Z_INDEX_SHIFT 7
#define Z_INDEX_MASK 0x180
