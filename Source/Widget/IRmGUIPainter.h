...
{
public:
	virtual RmRect boundingRect(int x, int y, int width, int height, RmString const& text, int cursor, int* row, int* column, RmRectRaw cursorRect = nullptr) = 0;

	virtual RmRect boundingRect(int x, int y, int width, int height, RmString const& text, int row, int column, int* cursor, RmRectRaw cursorRect = nullptr) = 0;
