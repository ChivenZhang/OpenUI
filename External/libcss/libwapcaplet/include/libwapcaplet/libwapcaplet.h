 ...
 */
inline lwc_error lwc_string_isequal(lwc_string *str1, lwc_string *str2, bool *ret)
{
	*(ret) = (str1 == str2);
	return lwc_error_ok;
}
 ...
 */
inline const char* lwc_string_data(lwc_string *str)
{
	assert(str != NULL);
 ...
 */
inline int lwc_string_length(lwc_string *str)
{
	assert(str != NULL);
	return str->len;
}
 ...
 */
inline lwc_hash lwc_string_hash_value(lwc_string *str)
{
	assert(str != NULL);
	return str->hash;
}
