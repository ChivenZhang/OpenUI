...
style = {
    ...
    ('border_radius_top_left', 2, 'length', 'CSS_BORDER_RADIUS_SET'),
    ('border_radius_top_right', 2, 'length', 'CSS_BORDER_RADIUS_SET'),
    ('border_radius_bottom_right', 2, 'length', 'CSS_BORDER_RADIUS_SET'),
    ('border_radius_bottom_left', 2, 'length', 'CSS_BORDER_RADIUS_SET'),
